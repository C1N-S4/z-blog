...
<?php }}else {echo "NO RESULT !";}?>
                ...
                <div class="col col-lg-4 col-md-4 col-sm-12 col-xs-12 col-12">
                    ...
                    <div class="bg-white p-3">
                        <div class="input-group"><form action="" method="POST"><span class="input-group-text">SEARCH</span><input class="form-control" name="search" type="text"><input class="btn btn-primary" type="submit" value="Find"></form></div>
                    </div>
